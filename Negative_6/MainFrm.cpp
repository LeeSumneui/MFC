...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_wndSpiltter.CreateStatic(this,1,3);
	m_wndSpiltter.CreateView(0,0,RUNTIME_CLASS(CNegative_6View),CSize(300,300),pContext);
	m_wndSpiltter.CreateView(0,1,RUNTIME_CLASS(CNegative_6VIew_2),CSize(300,300),pContext);
	m_wndSpiltter.CreateView(0,2,RUNTIME_CLASS(CNegative_6FormView),CSize(150,300),pContext);
