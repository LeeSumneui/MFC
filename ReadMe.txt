================================================================================
    MFC 라이브러리 : Negative_6 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 Negative_6 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 Negative_6 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
Negative_6.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CNegative_6App 응용 프로그램
    클래스를 선언합니다.

Negative_6.cpp
    응용 프로그램 클래스 CNegative_6App이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\Negative_6.ico
    ...
    주 리소스 파일인 Negative_6.rc에 의해 포함됩니다.
...
Negative_6Doc.h, Negative_6Doc.cpp - 문서
    이 파일에는 CNegative_6Doc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CNegative_6Doc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

Negative_6View.h, Negative_6View.cpp - 문서 뷰
    이 파일에는 CNegative_6View 클래스가 들어 있습니다.
    CNegative_6View 개체는 CNegative_6Doc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 Negative_6.pch와
